...
This README also available in [russian](https://github.com/verybigman/bem-typo/blob/master/CONTRIBUTING.ru.md).

You can read more about workflow on GitHub [guides](http://guides.github.com/).

### How to contribute

1. [Create an issue](https://github.com/verybigman/bem-typo/issues/new) with description or take from available.
